...
export default function Input({type, placeholder, errors, ...props}) {
    return (
        <div className='relative'>
            <input type={type} className='py-2 px-4 block w-full rounded-lg text-sm focus:z-10 focus:outline-none focus:ring-1 focus:ring-sky-500 text-gray-700 border' placeholder={placeholder} {...props}/>
            {errors &&
